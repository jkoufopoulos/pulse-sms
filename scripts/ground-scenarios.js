...
Pulse is an SMS service — users text a vibe, category, neighborhood, or anything they're in the mood for and get curated NYC event picks. They can reply numbers for details, "more" for extra picks, filter by category ("comedy", "jazz"), price ("free"), time ("later tonight", "this weekend"), or switch neighborhoods.
