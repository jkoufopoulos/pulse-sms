...
const MODELS = {
  brain:    process.env.PULSE_MODEL_BRAIN    || 'claude-sonnet-4-6', // tool calling + SMS composition (Sonnet — Haiku can't hold session memory reliably)
  ...
  fallback: process.env.PULSE_MODEL_FALLBACK || 'gemini-2.5-flash',  // fallback — cross-provider so auth failures recover
};
